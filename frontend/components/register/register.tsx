  ...
  return (
    <div className="flex h-screen font-sans bg-white">
      <div className="w-3/5 flex flex-col items-center justify-center px-10 text-black">
        ...
        <h2 className="text-2xl font-semibold mb-6">Đăng kí</h2>
      ...
      <div className="w-2/5 bg-[#049BD2] text-white flex flex-col items-center justify-center rounded-tl-[80px] rounded-bl-[80px] p-8">
